...
/**
 * This is just the main class to start the adapter
 * 
 * @author Kay Koedel
 */
public class EIFEventConverter {
	...
	public static void main(String[] args) {
		...
		EIFAdapterServer adapter = new EIFAdapterServer();
		...
		log.info("*************************************************************************");
		log.info("Starting EIFEventConverter ... ");
		log.info("*************************************************************************");
		adapter.start();
